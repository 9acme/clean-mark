...
const regexps = {
  ...
  unlikelyCandidatesRe:
    /combx|pager|disqus|foot|header|menu|meta|nav|rss|shoutbox|sidebar|sponsor|share|bookmark|social|advert|leaderboard|instapaper_ignore|entry-unrelated|read-more/i,
...
function getCandidates($, base) {
  ...
  $('*', 'body').each(function (index, element) {
    ...
    if (regexps.unlikelyCandidatesRe.test(classAndID) && !regexps.okMaybeItsACandidateRe.test(classAndID)) {
      return node.remove();
    }
